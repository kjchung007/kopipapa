...
export const metadata: Metadata = { metadataBase:new URL(process.env.NEXT_PUBLIC_SITE_URL || (process.env.NODE_ENV === "production" ? "https://kopipapa.vercel.app" : "http://localhost:3000")),title:{default:"Kopi Papa | Born in Sarawak",template:"%s | Kopi Papa"},description:"Traditional local kopi meets modern coffee culture. Born in Sarawak and brewed forward.",openGraph:{title:"Kopi Papa",description:"Born in Sarawak. Brewed forward.",images:["/assets/customer-cup.webp"]} };
